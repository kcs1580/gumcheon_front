<template>
  ...
  <div style="text-align: center">
    <v-card flat width="375px" style="padding-top: 81px; padding-bottom: 15px"
      ><button text>
        <div style="width: 239px; height: 50px; display: inline-block">
          <v-img @click="gotoUrl('/')" src="@/assets/img/gfmc_ci_gray.png" />
        </div>
      </button>
      ...
      <v-card rounded="xl" width="321px">
        <v-row no-gutters align="center" justify="center">
          ...
          <v-btn
            ...
            width="266"
            color="#0276F9"
            ><div class="login-btn white--text">
              비밀번호 초기화 신청
            </div></v-btn
          >
        </v-row>
      ...
      <v-card rounded="xl" width="321px">
        <v-row no-gutters align="center" justify="center">
          ...
          <v-btn
            ...
            width="266"
            color="#0276F9"
            ><div class="login-btn white--text">비밀번호 변경</div></v-btn
          >
        </v-row>
      </v-card>
    </v-dialog>
